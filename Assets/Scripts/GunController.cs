...
public class GunController : MonoBehaviour
{
    ...
    void HandleTouchInput()
    {
        if (Input.touchCount > 0)
        {
            ...
            if ((touch.phase == TouchPhase.Began || touch.phase == TouchPhase.Moved) && !hasShotThisTap)
            {
...
public void SetProjectileColorRed()
    {
        selectedColor = Color.red;
    }

    public void SetProjectileColorBlue()
    {
        selectedColor = Color.blue;
    }


    public void SetProjectileColorYellow()
    {
